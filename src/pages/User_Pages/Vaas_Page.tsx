            ...
            >
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg" style={{ color: `${colors.primaryDark}AA` }}>
                            A streamlined, four‑phase verification process.
                        </p>
                    </div>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    >
                        <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                            ...
                            <span className="gradient-text">carbon verification?</span>
                        </h2>
                        <p className="text-lg mb-8 max-w-xl mx-auto" style={{ color: `${colors.primaryDark}BB` }}>
                            Get in touch with our MRV specialists to discuss your project's verification needs.
                        </p>
